...
if (isset($_GET['update'])) {
  ...
  $query_update = mysqli_query($koneksi,"UPDATE anggota SET nis ='$nis',nama ='$nama',kelas ='$kelas',jurusan ='$jurusan',tanggal_lahir ='$tgl_lahir',no_telepon ='$tlp',alamat ='$alamat',jenis_kelamin ='$jk'WHERE id_anggota = '$id'");
...
<!-- Form Input Anggota -------------------------------------------------------- -->
            ...
            <input class="hidden" name="id_anggota" value="<?php echo $row['id_anggota'];?>">
                ...
                <div class="form-group mt-2">
                    <input class="form-control" type="text" name="nama" placeholder="Isi Nama Siswa" required>
                </div>
                <div class="form-group mt-2">
